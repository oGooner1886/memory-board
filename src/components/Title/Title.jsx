...
const Title = () => {
  return (
    <div className={style.wrapper}>
      ...
      <p className={style.description_mobile}>
        Цифровые волонтёры Астраханской  области о своих предках,
        сражавшихся  в годы<br></br> Великой Отечественной войны <br></br> за
        свободу, за мир, за Родину.
      </p>
    </div>
  );
};
